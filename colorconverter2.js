 ...
 * https://github.com/Q42/hue-color-converter/blob/master/colorconverter.ts
 */
var colorConverter2;
(function (colorConverter2) {
    function MakeRgbSmallerThenOne(rgb) {
        rgb.r = rgb.r / 255;
        rgb.g = rgb.g / 255;
        rgb.b = rgb.b / 255;
        return rgb;
    }
    colorConverter2.MakeRgbSmallerThenOne = MakeRgbSmallerThenOne;
    ;
    function xyBriToRgb(xyb) {
        ...
        var cap = function (x) { return Math.max(0, Math.min(1, x)); };
        return { r: cap(r), g: cap(g), b: cap(b) };
    }
    colorConverter2.xyBriToRgb = xyBriToRgb;
    ...
    colorConverter2.rgbToXyBri = rgbToXyBri;
    ...
    colorConverter2.rgbToHexString = rgbToHexString;
    ...
    colorConverter2.hexStringToRgb = hexStringToRgb;
    function hexStringToXyBri(s) {
        return rgbToXyBri(hexStringToRgb(s));
    }
    colorConverter2.hexStringToXyBri = hexStringToXyBri;
    var hueBulbs = ['LCT001'];
    var livingColors = [
        'LLC006',
        'LLC007',
    ...
    colorConverter2.xyForModel = xyForModel;
    function xyBriForModel(xyb, model) {
        var xy = xyForModel(xyb, model);
        return { x: xy.x, y: xy.y, bri: xyb.bri };
    }
    colorConverter2.xyBriForModel = xyBriForModel;
})(colorConverter2 = exports.colorConverter2 || (exports.colorConverter2 = {}));
//# sourceMappingURL=colorconverter2.js.map