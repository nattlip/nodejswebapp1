...
/// <reference path="../script2.ts" />
  ...
  class canvascreatepage
{
      constructor(DatastoreString, ipandportstring)
      {
    ...
    { this.httpaddress = "http://" + this.ip + ":" + this.port + "/PhilipsHueColorPicter2?Bridgeid=" + this.sref };
          ...
          this.size =  function (obj) { var size = 0, key; for (key in obj) { if (obj.hasOwnProperty(key)) size++; } return size; };
   ...
   colorcanvasplaceholderdiv: HTMLDivElement = undefined;
   whitecanvasplaceholderdiv: HTMLDivElement = undefined;
   slidercanvasplaceholderdiv: HTMLDivElement = undefined;
...
deltax ; // 10 pixels padding of circleMap in return to colormap
deltay;
xmap ;  //   x coordinate  of centre circle  0,0 on colormap 10,10 on circleMap          if var then not global
ymap;  //   y of centre circle
      radius; //   radius of circle
colorMapCanvasWidth;
colorMapCanvasHeight ;
circleMapCanvasWidth ;
circleMapCanvasHeight ;
...
maxspanindexlength = null;
maxspannamelength = null;

      //if (port == "80")
      //{ this.httpaddress = "http://" + this.ip + "/PhilipsHueColorPicker2"; }
      //else
      //{ this.httpaddress = "http://" + this.ip + ":" + this.port + "/PhilipsHueColorPicker2" };
     ...
     CalculateSliderElementsLenghts = function ()
    {
   ...
   createsliderplaceholder = function ()
    {
  ...
  createchildtable = function ()
    {
      ...
      var   textinputbrightness = document.createElement("input");
        ...
        for (var k = 1 ; k < 6 ; k++)
        {
            ...
            switch (k)
            {
                case 1: rowrgb = "red"; colorletter = "R"; break;
                case 2: rowrgb = "green"; colorletter = "G"; break;
                case 3: rowrgb = "blue"; colorletter = "B"; break;
                case 4: rowrgb = "hex"; colorletter = "Hex"; break;
                case 5: rowrgb = "slider"; colorletter = "Slider"; break;
   ...
   createbridgeidandbackbutton = function ()
    {
    ...
    Hi = function ()
    {
      ...
      UpdateLightVariables = function (LightsUpdate)
      {
   ...
   SendPointState = function (idpoint, key, value)
    {
