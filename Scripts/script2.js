...
var fillpropertiesadddevice = function (data) {
    ...
    var selectio = document.getElementById("SelectIfIo");
...
var fillpropertieselecteddevice = function (data) {
    ...
    ;
    var selected = document.getElementById("Selectdevice");
 ...
 */
var createbutton = function (buttonid, buttonval, buttonfunction) {
...
* returns var button
 */
var createbutton2 = function (buttonid, buttonval, buttonfunction) {
    var button = document.createElement("input");
    button.id = buttonid;
    button.value = buttonval;
    button.type = "button";
...
var createbutton3 = function (id, buttonid, buttonval, buttonfunction) {
    var button = document.createElement("input");
    button.id = buttonid;
    button.value = buttonval;
    button.type = "button";
...
var createbutton4 = function (id, buttonid, buttonval, lightstatefunction, lightstatevalue, buttonfunction) {
    var button = document.createElement("input");
    button.id = buttonid;
    button.value = buttonval;
    button.type = "button";
...
var createbutton5 = function (buttonid, buttonval, buttonfunction, devicecode, devicefunction) {
    var button = document.createElement("input");
    button.id = buttonid;
    button.value = buttonval;
    button.type = "button";
...
var createbutton6 = function (buttonid, buttonval, buttonfunction, a, b, c, d, devicefunction) {
    var button = document.createElement("input");
    button.id = buttonid;
    button.value = buttonval;
    button.type = "button";
...
var createmenu = function (menuJson) {
    ...
    function makesubsublist(menuobject, i, j, k, usubsublist) {
        //menuitems
        var sslistel = document.createElement("li");
...
var SimpleStringsTable = function (sendstrings) {
    if (simplestringscount == -1) {
        ...
        var parenttablediv = document.getElementById("parenttable2");
    }
    var parentrowdiv = document.createElement("div");
...
var selectcomport = function () {
    var y = document.getElementById("rfxcomport").value;
    var j = {
        rfxcomport: y
    };
    var json = JSON.stringify(j);
...
var makeObjectJson = function (key, value) {
    var item = {};
    item[key] = value;
